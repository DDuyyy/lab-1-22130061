...
public class Environment {
	...
	public EnvironmentState executeAction(Action action) {
		if (action == MOVE_LEFT) {
			// Implement logic for moving the agent left
		} else if (action == MOVE_RIGHT) {
			// Implement logic for moving the agent right
		} else if (action == SUCK_DIRT) {
			// Implement logic for the agent sucking dirt
		}
		// Update and return the modified environment state
		return envState;
	}
